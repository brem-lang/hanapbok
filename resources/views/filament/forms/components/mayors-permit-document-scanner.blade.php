<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    <div x-data="mayorsPermitDocumentScanner({
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div class="flex items-center gap-3">
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-200">Mayor's Permit Documents Scanner</h3>
    ...
    @push('scripts')
        <script>
            function mayorsPermitDocumentScanner({
                statePath,
                existingDocuments,
                currentState
            }) {
