    ...
    <div x-data="documentScanner({
        ...
        <div x-show="existingDocuments.length > 0" class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
            ...
            <div class="grid grid-cols-3 gap-2">
                <template x-for="(document, index) in existingDocuments" :key="index">
                    <div
                        class="bg-white dark:bg-gray-700 rounded-md border border-gray-300 dark:border-gray-600 p-2 hover:shadow-md transition-shadow">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300">BIR Documents</h3>
                <button type="button" @click="toggleScanner()" x-show="capturedImages.length === 0"
            ...
            <div x-show="isScanning" x-transition:enter="transition ease-out duration-200"
                ...
                <div class="relative z-[100] p-3 sm:p-4 md:p-6 flex justify-center items-center"
                    ...
                    <button type="button" @click="captureImage()"
                        ...
                        style="background-color: #16a34a !important; border-width: 3px;"
            ...
            <div x-show="capturedImages.length > 0" class="mt-3">
                <h4 class="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Captured Documents (<span
                        x-text="capturedImages.length"></span>)</h4>
                <div class="grid grid-cols-3 gap-2">
            ...
            {{-- Image Preview Modal --}}
            <div x-show="showImagePreview" x-transition:enter="transition ease-out duration-200"
                x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                x-transition:leave-end="opacity-0"
                class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75" style="z-index: 10000;"
            ...
            {{-- Name Input Modal --}}
            <div x-show="showNameModal" x-transition:enter="transition ease-out duration-200"
                x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                x-transition:leave-end="opacity-0"
                class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75" style="z-index: 10000;"
