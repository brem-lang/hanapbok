...
class BarangayClearanceDocumentScanner extends Field
{
    protected string $view = 'filament.forms.components.barangay-clearance-document-scanner';
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(function (BarangayClearanceDocumentScanner $component, $state) {
        ...
        $this->mutateDehydratedStateUsing(function (BarangayClearanceDocumentScanner $component, $state) {
            if (empty($state)) {
                return [];
            }
    ...
    public function getViewData(): array
    {
        ...
        $existingDocumentsRaw = $record ? ($record->barangay_clearance ?? []) : [];
