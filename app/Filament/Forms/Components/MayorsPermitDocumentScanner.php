...
class MayorsPermitDocumentScanner extends Field
{
    protected string $view = 'filament.forms.components.mayors-permit-document-scanner';
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(function (MayorsPermitDocumentScanner $component, $state) {
        ...
        $this->mutateDehydratedStateUsing(function (MayorsPermitDocumentScanner $component, $state) {
            if (empty($state)) {
                return [];
            }
    ...
    public function getViewData(): array
    {
        ...
        $existingDocumentsRaw = $record ? ($record->mayors_permit ?? []) : [];
