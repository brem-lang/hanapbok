...
class DocumentScanner extends Field
{
    protected string $view = 'filament.forms.components.document-scanner';
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(function (DocumentScanner $component, $state) {
        ...
        $this->mutateDehydratedStateUsing(function (DocumentScanner $component, $state) {
            if (empty($state)) {
                return [];
            }
    ...
    public function getViewData(): array
    {
        ...
        $existingDocumentsRaw = $record ? ($record->back_id ?? []) : [];
