...
class WasteManagementDocumentScanner extends Field
{
    protected string $view = 'filament.forms.components.waste-management-document-scanner';
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(function (WasteManagementDocumentScanner $component, $state) {
        ...
        $this->mutateDehydratedStateUsing(function (WasteManagementDocumentScanner $component, $state) {
            if (empty($state)) {
                return [];
            }
    ...
    public function getViewData(): array
    {
        ...
        $existingDocumentsRaw = $record ? ($record->waste_management ?? []) : [];
